...
#cp -u -p $scriptpath/envs/default/env_tf_onprem.env.default $scriptpath/envs/prod/env_tf_onprem.env
#cp -u -p $scriptpath/envs/default/env_tf_prod.env.default $scriptpath/envs/prod/env_tf_prod.env
